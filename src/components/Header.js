            ...
            <div className="flex items-center bg-amazon_blue p-1 flex-grow py-2">
                ...
                <div className="text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap">
                    <div
                        ...
                        className="flex flex-col hover:border hover:border-white cursor-pointer px-2 rounded-sm ">
                        <p className="">
                            {session
                    ...
                    <div
                        className="flex flex-col px-2 hover:border hover:border-white cursor-pointer rounded-sm "
                        onClick={() => router.push("/orders")}>
                        <p>Returns</p>
                        <p className="font-extrabold md:text-sm">& Orders</p>
                    </div>
                    <div
                        className="relative flex hover:border hover:border-white cursor-pointer rounded-sm  items-center"
